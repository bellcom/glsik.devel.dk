...
$(document).ready(function(){
$('.flowplayer-embed').each(function(){
var id = $(this).find('a.player').attr('id');
var playlistid = $(this).find('.playlist').attr('id');
$(function(){ $f(id, "/design/plain_site/flash/flowplayer-3.1.5.swf",
{clip:
{baseUrl: 'http://www.sik.dk/',
autoPlay: false,
autoBuffering: true
}
})
.playlist("#"+playlistid+":first");
});
});
});
(function (factory) {
