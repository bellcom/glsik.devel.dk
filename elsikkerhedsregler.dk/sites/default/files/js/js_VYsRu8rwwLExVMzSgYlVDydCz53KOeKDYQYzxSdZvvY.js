...
// | hjemmesidekongen.dk
// |
var legalNoticeToggle = (function ($) {
    'use strict';
    ...
    function registerEventHandlers() {
        ...
        // Toggle legal notice
        $('.paragraph-legal-chapters .paragraph-heading').on('click', function(event) {
            event.preventDefault();
            var $element = $(this);

            $element.closest('.paragraph-legal-chapter')
                .toggleClass('open');
        });
    }
...
(function ($) {
    ...
    // Enable legal notice toggle
    legalNoticeToggle.init();
